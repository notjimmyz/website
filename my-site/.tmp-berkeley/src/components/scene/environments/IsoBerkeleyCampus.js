...
exports.BerkeleyCampus = BerkeleyCampus;
const jsx_runtime_1 = require("react/jsx-runtime");
const project_1 = require("./iso/project");
const primitives_1 = require("./iso/primitives");
...
function BerkeleyCampus({ reduceMotion }) {
    const halls = [...HALLS, ...FILLERS].sort((a, b) => a.x + a.y - (b.x + b.y));
    return ((0, jsx_runtime_1.jsxs)("g", { "data-landmark": "uc-berkeley", children: [(0, jsx_runtime_1.jsx)(CampusGround, {}), (0, jsx_runtime_1.jsx)(Hills, { reduceMotion: reduceMotion }), (0, jsx_runtime_1.jsx)(GreekTheatre, {}), (0, jsx_runtime_1.jsx)(MemorialStadium, {}), (0, jsx_runtime_1.jsx)(MaxwellField, {}), (0, jsx_runtime_1.jsx)(GoldmanField, {}), (0, jsx_runtime_1.jsx)(EdwardsTrack, {}), (0, jsx_runtime_1.jsx)(EvansDiamond, {}), (0, jsx_runtime_1.jsx)(SpiekerPool, {}), (0, jsx_runtime_1.jsx)(HellmanTennis, {}), (0, jsx_runtime_1.jsx)(FoundersRock, {}), halls.map((hall) => ((0, jsx_runtime_1.jsx)(Hall, { ...hall }, hall.name))), (0, jsx_runtime_1.jsx)(Campanile, {}), (0, jsx_runtime_1.jsx)(SatherGate, {}), (0, jsx_runtime_1.jsx)(LudwigsFountain, {}), (0, jsx_runtime_1.jsx)(Trees, { reduceMotion: reduceMotion }), (0, jsx_runtime_1.jsx)(Life, { reduceMotion: reduceMotion }), (0, jsx_runtime_1.jsx)(Labels, {})] }));
}
function CampusGround() {
    return ((0, jsx_runtime_1.jsxs)("g", { "data-layer": "ground", children: [(0, jsx_runtime_1.jsx)(primitives_1.IsoSlab, { x: 5.4, y: -34.2, w: 50.0, d: 18.4, h: 0.08, ...GRASS }), (0, jsx_runtime_1.jsx)(primitives_1.IsoSlab, { x: 18.4, y: -16.4, w: 28.0, d: 22.0, h: 0.08, ...GRASS }), (0, jsx_runtime_1.jsx)(primitives_1.IsoSlab, { x: 5.6, y: -16.0, w: 16.0, d: 30.4, h: 0.08, ...GRASS }), (0, jsx_runtime_1.jsx)(primitives_1.IsoSlab, { x: 28.0, y: 5.4, w: 32.0, d: 18.6, h: 0.08, ...GRASS }), (0, jsx_runtime_1.jsx)(primitives_1.IsoSlab, { x: 54.0, y: -28.0, w: 24.0, d: 38.0, h: 0.08, ...GRASS }), (0, jsx_runtime_1.jsx)(primitives_1.IsoSlab, { x: 4.2, y: -34.4, w: 1.15, d: 62.4, h: 0.14, ...ROAD }), (0, jsx_runtime_1.jsx)(primitives_1.IsoSlab, { x: 5.2, y: -32.15, w: 52.4, d: 0.9, h: 0.14, ...ROAD }), (0, jsx_runtime_1.jsx)(primitives_1.IsoSlab, { x: 5.2, y: 26.35, w: 52.0, d: 0.9, h: 0.14, ...ROAD }), (0, jsx_runtime_1.jsx)(primitives_1.IsoSlab, { x: 75.4, y: -22.0, w: 1.1, d: 34.0, h: 0.14, ...ROAD }), (0, jsx_runtime_1.jsx)(NamedLawn, { x: 22.0, y: -16.5, w: 19.2, d: 11.6, stripes: 16 }), (0, jsx_runtime_1.jsx)(NamedLawn, { x: 44.6, y: -1.55, w: 3.1, d: 2.3, stripes: 4 }), (0, jsx_runtime_1.jsx)(NamedLawn, { x: 54.6, y: 5.2, w: 3.0, d: 1.8, stripes: 3 }), (0, jsx_runtime_1.jsx)(NamedLawn, { x: 20.1, y: 5.25, w: 4.9, d: 4.15, stripes: 5 }), (0, jsx_runtime_1.jsx)(IsoDisc, { x: 42.4, y: -23.6, z: 0.12, r: 1.85, fill: PLAZA.top }), (0, jsx_runtime_1.jsx)(IsoDisc, { x: 10.4, y: -0.4, z: 0.12, r: 2.55, fill: GRASS.top }), (0, jsx_runtime_1.jsx)(Spine, {}), (0, jsx_runtime_1.jsx)(Paths, {}), (0, jsx_runtime_1.jsx)(Creek, {})] }));
}
function Spine() {
    ...
    return ((0, jsx_runtime_1.jsxs)("g", { "data-layer": "sather-spine", children: [(0, jsx_runtime_1.jsx)(primitives_1.IsoSlab, { x: plazaX, y: GATE_Y + 0.62, w: plazaW, d: 7.35, h: 0.16, ...PLAZA }), (0, jsx_runtime_1.jsx)(primitives_1.IsoSlab, { x: pinchX, y: GATE_Y, w: GATE_INNER, d: 0.72, h: 0.18, ...PLAZA }), (0, jsx_runtime_1.jsx)(primitives_1.IsoSlab, { x: SPINE_X, y: DOE_SOUTH + 0.62, w: SPINE_W, d: roadD - 0.62, h: 0.16, ...PLAZA }), (0, jsx_runtime_1.jsx)(primitives_1.IsoSlab, { x: SPINE_X - 1.4, y: DOE_SOUTH, w: SPINE_W + 2.8, d: 0.78, h: 0.17, ...PLAZA }), (0, jsx_runtime_1.jsx)(primitives_1.IsoSlab, { x: 20.6, y: DOE_SOUTH + 0.1, w: 26.8, d: 0.58, h: 0.15, ...PATH }), (0, jsx_runtime_1.jsx)(primitives_1.IsoSlab, { x: 40.8, y: -8.7, w: 4.8, d: 4.5, h: 0.13, ...PLAZA })] }));
}
function Paths() {
    const slabs = [
    ...
    return ((0, jsx_runtime_1.jsx)("g", { "data-layer": "paths", children: slabs.map((slab) => ((0, jsx_runtime_1.jsx)(primitives_1.IsoSlab, { ...slab, h: 0.12, ...PATH }, `${slab.x}-${slab.y}`))) }));
}
function Creek() {
    const bands = [
    ...
    return ((0, jsx_runtime_1.jsx)("g", { "data-landmark": "strawberry-creek", children: bands.map((band) => ((0, jsx_runtime_1.jsx)(primitives_1.IsoSlab, { ...band, h: 0.11, ...WATER }, `${band.x}-${band.y}`))) }));
}
function Hills({ reduceMotion }) {
    return ((0, jsx_runtime_1.jsxs)("g", { "data-layer": "hills", children: [(0, jsx_runtime_1.jsx)(primitives_1.IsoSlab, { x: 68.4, y: -28.4, w: 12.4, d: 22.0, h: 0.7, ...GRASS }), (0, jsx_runtime_1.jsx)(primitives_1.IsoSlab, { x: 71.2, y: -26.0, w: 9.2, d: 16.4, h: 1.35, top: "#B5D389", left: "#88B078", right: "#9EC48A" }), [
                [70.0, -26.8],
                [73.2, -24.4],
                [76.0, -22.0],
                [71.4, -20.2],
                ...
                [77.0, -9.0],
                [74.2, -6.6],
            ].map(([x, y], index) => ((0, jsx_runtime_1.jsx)(primitives_1.IsoTree, { x: x, y: y, canopy: index % 2 === 0 ? "#7EBE7A" : "#6FA86C", delay: `${(index % 5) * 0.2}s`, reduceMotion: reduceMotion }, `${x}-${y}`)))] }));
}
function GreekTheatre() {
    const cx = 62.0;
    const cy = -18.6;
    return ((0, jsx_runtime_1.jsxs)("g", { "data-landmark": "greek-theatre", children: [(0, jsx_runtime_1.jsx)(IsoDisc, { x: cx, y: cy, z: 0.14, r: 2.65, fill: STONE.top }), (0, jsx_runtime_1.jsx)(IsoDisc, { x: cx, y: cy, z: 0.18, r: 1.9, fill: PLAZA.top }), (0, jsx_runtime_1.jsx)(IsoDisc, { x: cx, y: cy, z: 0.22, r: 1.1, fill: GRASS.top }), (0, jsx_runtime_1.jsx)(primitives_1.IsoBox, { x: cx - 1.2, y: cy + 1.55, z: 0.16, w: 2.4, d: 0.5, h: 0.65, ...STONE })] }));
}
function MemorialStadium() {
    ...
    const outer = 3.35;
    const inner = 2.05;
    return ((0, jsx_runtime_1.jsxs)("g", { "data-landmark": "memorial-stadium", children: [(0, jsx_runtime_1.jsx)(IsoDisc, { x: cx, y: cy - stretch, z: 0.14, r: outer, fill: STONE.top }), (0, jsx_runtime_1.jsx)(IsoDisc, { x: cx, y: cy + stretch, z: 0.14, r: outer, fill: STONE.top }), (0, jsx_runtime_1.jsx)(primitives_1.IsoSlab, { x: cx - outer, y: cy - stretch, w: outer * 2, d: stretch * 2, h: 0.14, ...STONE }), (0, jsx_runtime_1.jsx)(IsoDisc, { x: cx, y: cy - stretch, z: 0.2, r: inner, fill: GRASS.top }), (0, jsx_runtime_1.jsx)(IsoDisc, { x: cx, y: cy + stretch, z: 0.2, r: inner, fill: GRASS.top }), (0, jsx_runtime_1.jsx)(primitives_1.IsoSlab, { x: cx - inner, y: cy - stretch, z: 0.06, w: inner * 2, d: stretch * 2, h: 0.16, ...GRASS }), (0, jsx_runtime_1.jsx)(primitives_1.IsoBox, { x: cx - 1.65, y: cy - stretch - 0.32, z: 0.16, w: 3.3, d: 0.5, h: 1.05, ...STONE })] }));
}
function MaxwellField() {
    return ((0, jsx_runtime_1.jsx)("g", { "data-landmark": "maxwell-field", children: (0, jsx_runtime_1.jsx)(NamedLawn, { x: 69.4, y: 5.6, w: 5.2, d: 3.6, stripes: 6 }) }));
}
function GoldmanField() {
    return ((0, jsx_runtime_1.jsx)("g", { "data-landmark": "goldman-field", children: (0, jsx_runtime_1.jsx)(NamedLawn, { x: 6.2, y: 21.0, w: 4.0, d: 3.4, stripes: 5 }) }));
}
function EdwardsTrack() {
    ...
    const outer = 2.15;
    const inner = 1.2;
    return ((0, jsx_runtime_1.jsxs)("g", { "data-landmark": "edwards-track", children: [(0, jsx_runtime_1.jsx)(IsoDisc, { x: cx, y: cy - stretch, z: 0.14, r: outer, fill: TRACK.top }), (0, jsx_runtime_1.jsx)(IsoDisc, { x: cx, y: cy + stretch, z: 0.14, r: outer, fill: TRACK.top }), (0, jsx_runtime_1.jsx)(primitives_1.IsoSlab, { x: cx - outer, y: cy - stretch, w: outer * 2, d: stretch * 2, h: 0.14, ...TRACK }), (0, jsx_runtime_1.jsx)(IsoDisc, { x: cx, y: cy - stretch, z: 0.18, r: inner, fill: GRASS.top }), (0, jsx_runtime_1.jsx)(IsoDisc, { x: cx, y: cy + stretch, z: 0.18, r: inner, fill: GRASS.top }), (0, jsx_runtime_1.jsx)(primitives_1.IsoSlab, { x: cx - inner, y: cy - stretch, z: 0.04, w: inner * 2, d: stretch * 2, h: 0.15, ...GRASS })] }));
}
function EvansDiamond() {
    return ((0, jsx_runtime_1.jsxs)("g", { "data-landmark": "evans-diamond", children: [(0, jsx_runtime_1.jsx)(primitives_1.IsoSlab, { x: 18.6, y: 20.8, w: 3.2, d: 2.8, h: 0.12, ...DIRT }), (0, jsx_runtime_1.jsx)(NamedLawn, { x: 19.0, y: 21.1, w: 2.3, d: 2.0, stripes: 3 })] }));
}
function SpiekerPool() {
    return ((0, jsx_runtime_1.jsx)("g", { "data-landmark": "spieker-pool", children: (0, jsx_runtime_1.jsx)(primitives_1.IsoSlab, { x: 6.3, y: 6.7, w: 3.8, d: 1.5, h: 0.12, ...WATER }) }));
}
function HellmanTennis() {
    return ((0, jsx_runtime_1.jsxs)("g", { "data-landmark": "hellman-tennis", children: [(0, jsx_runtime_1.jsx)(Court, { x: 6.4, y: 13.4, w: 1.7, d: 3.2 }), (0, jsx_runtime_1.jsx)(Court, { x: 8.3, y: 13.4, w: 1.7, d: 3.2 }), (0, jsx_runtime_1.jsx)(Court, { x: 10.2, y: 13.4, w: 1.7, d: 3.2 })] }));
}
function FoundersRock() {
    return ((0, jsx_runtime_1.jsxs)("g", { "data-landmark": "founders-rock", children: [(0, jsx_runtime_1.jsx)(primitives_1.IsoBox, { x: 50.4, y: -31.4, z: 0.16, w: 0.9, d: 0.75, h: 0.55, ...STONE }), (0, jsx_runtime_1.jsx)(primitives_1.IsoBox, { x: 50.7, y: -31.2, z: 0.7, w: 0.48, d: 0.4, h: 0.28, ...STONE })] }));
}
function Campanile() {
    const x = 42.35;
    const y = -7.62;
    ...
    const d = 1.08;
    const shaft = 11.2;
    return ((0, jsx_runtime_1.jsxs)("g", { "data-landmark": "sather-tower", className: "iso-hover", style: { pointerEvents: "auto" }, children: [(0, jsx_runtime_1.jsx)(primitives_1.IsoBox, { x: x - 0.16, y: y - 0.16, z: 0.16, w: w + 0.32, d: d + 0.32, h: 0.28, ...STONE }), (0, jsx_runtime_1.jsx)(primitives_1.IsoBox, { x: x, y: y, z: 0.44, w: w, d: d, h: shaft, ...STONE }), (0, jsx_runtime_1.jsx)(primitives_1.IsoWindows, { face: "left", x: x, y: y, z: 0.44, w: w, d: d, h: shaft, cols: 1, rows: 8, fill: WINDOW, v0: 0.06, v1: 0.92 }), (0, jsx_runtime_1.jsx)(primitives_1.IsoWindows, { face: "right", x: x, y: y, z: 0.44, w: w, d: d, h: shaft, cols: 1, rows: 8, fill: WINDOW, v0: 0.06, v1: 0.92 }), (0, jsx_runtime_1.jsx)(primitives_1.IsoBox, { x: x - 0.14, y: y - 0.14, z: 0.44 + shaft, w: w + 0.28, d: d + 0.28, h: 0.85, ...STONE }), (0, jsx_runtime_1.jsx)(primitives_1.IsoWindows, { face: "left", x: x - 0.14, y: y - 0.14, z: 0.44 + shaft, w: w + 0.28, d: d + 0.28, h: 0.85, cols: 2, rows: 1, fill: WINDOW, v0: 0.22, v1: 0.78 }), (0, jsx_runtime_1.jsx)(primitives_1.IsoGable, { x: x - 0.14, y: y - 0.14, z: 1.29 + shaft, w: w + 0.28, d: d + 0.28, rise: 1.15, left: TILE.left, right: TILE.right }), (0, jsx_runtime_1.jsx)(primitives_1.IsoBox, { x: x + w * 0.42, y: y + d * 0.42, z: 2.4 + shaft, w: 0.16, d: 0.16, h: 0.7, top: TILE.top, left: TILE.left, right: TILE.right })] }));
}
function SatherGate() {
    const z = 0.2;
    const post = 0.44;
    ...
    return ((0, jsx_runtime_1.jsxs)("g", { "data-landmark": "sather-gate", className: "iso-hover", style: { pointerEvents: "auto" }, children: [(0, jsx_runtime_1.jsx)(primitives_1.IsoBox, { x: x - 0.35, y: y - 0.08, z: z, w: span + 0.7, d: depth + 0.18, h: 0.22, ...STONE }), posts.map((px) => ((0, jsx_runtime_1.jsx)(primitives_1.IsoBox, { x: px, y: y, z: z + 0.22, w: post, d: depth, h: height, ...STONE }, px))), (0, jsx_runtime_1.jsx)(primitives_1.IsoBox, { x: x - 0.22, y: y - 0.1, z: z + 0.22 + height, w: span + 0.44, d: depth + 0.2, h: 0.55, ...STONE }), (0, jsx_runtime_1.jsx)(primitives_1.IsoBox, { x: x - 0.28, y: y - 0.12, z: z + 0.77 + height, w: span + 0.56, d: depth + 0.24, h: 0.28, top: "#7E8F6A", left: "#5E6E52", right: "#6E7E5E" }), (0, jsx_runtime_1.jsx)(primitives_1.IsoGable, { x: x - 0.28, y: y - 0.12, z: z + 1.05 + height, w: span + 0.56, d: depth + 0.24, rise: 0.72, left: "#5E6E52", right: "#6E7E5E" })] }));
}
function LudwigsFountain() {
    return ((0, jsx_runtime_1.jsxs)("g", { "data-landmark": "ludwigs-fountain", children: [(0, jsx_runtime_1.jsx)(IsoDisc, { x: SPINE_MID, y: 14.45, z: 0.22, r: 0.78, fill: STONE.top }), (0, jsx_runtime_1.jsx)(IsoDisc, { x: SPINE_MID, y: 14.45, z: 0.34, r: 0.52, fill: WATER.top })] }));
}
function Hall({ name, x, y, w, d, h, kind = "classic", roof = "tile", wings = [], }) {
    return ((0, jsx_runtime_1.jsxs)("g", { className: "iso-hover", style: { pointerEvents: "auto" }, "data-landmark": name, children: [(0, jsx_runtime_1.jsx)(HallBox, { x: x, y: y, w: w, d: d, h: h, kind: kind, roof: roof }), wings.map((wing, index) => ((0, jsx_runtime_1.jsx)(HallBox, { x: wing.x, y: wing.y, w: wing.w, d: wing.d, h: wing.h ?? h * 0.92, kind: kind, roof: roof }, `${name}-wing-${index}`)))] }));
}
function HallBox({ x, y, w, d, h, kind, roof, }) {
    ...
    return ((0, jsx_runtime_1.jsxs)("g", { children: [(0, jsx_runtime_1.jsx)(primitives_1.IsoBox, { x: x, y: y, z: 0.16, w: w, d: d, h: h, ...wall }), (0, jsx_runtime_1.jsx)(primitives_1.IsoWindows, { face: "left", x: x, y: y, z: 0.16, w: w, d: d, h: h, cols: cols, rows: rows, fill: glass }), (0, jsx_runtime_1.jsx)(primitives_1.IsoWindows, { face: "right", x: x, y: y, z: 0.16, w: w, d: d, h: h, cols: 1, rows: Math.max(2, rows - 1), fill: glass }), kind === "classic" ? (0, jsx_runtime_1.jsx)(primitives_1.IsoFascia, { x: x, y: y, z: 0.16, w: w, d: d, h: h, fill: "#D8C49A" }) : null, roof === "flat" ? ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsx)(primitives_1.IsoBox, { x: x + 0.1, y: y + 0.1, z: 0.16 + h, w: w - 0.2, d: d - 0.2, h: 0.1, top: "#E8ECF0", left: "#C4C8CC", right: "#D4D8DC" }), (0, jsx_runtime_1.jsx)(primitives_1.IsoBox, { x: x + w * 0.38, y: y + d * 0.32, z: 0.26 + h, w: 0.38, d: 0.28, h: 0.24, ...SLATE })] })) : roof === "gable" ? ((0, jsx_runtime_1.jsx)(primitives_1.IsoGable, { x: x, y: y, z: 0.16 + h, w: w, d: d, rise: 0.68, left: TILE.left, right: TILE.right })) : ((0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsx)(primitives_1.IsoBox, { x: x - 0.05, y: y - 0.05, z: 0.16 + h, w: w + 0.1, d: d + 0.1, h: 0.16, ...TILE }), (0, jsx_runtime_1.jsx)(primitives_1.IsoBox, { x: x + w * 0.42, y: y + d * 0.38, z: 0.32 + h, w: 0.24, d: 0.24, h: 0.36, ...TILE })] }))] }));
}
function Labels() {
    const places = [
    ...
    return ((0, jsx_runtime_1.jsxs)("g", { "data-layer": "labels", children: [HALLS.filter((hall) => hall.label !== false).map((hall) => ((0, jsx_runtime_1.jsx)(PlaceName, { x: hall.x + hall.w / 2 + (hall.lx ?? 0), y: hall.y + hall.d * 0.55 + (hall.ly ?? 0), z: hall.h + 0.7 + (hall.lz ?? 0), size: hall.size ?? 8, children: hall.name }, hall.name))), places.map((place) => ((0, jsx_runtime_1.jsx)(PlaceName, { x: place.x, y: place.y, z: place.z, size: place.size, children: place.name }, place.name)))] }));
}
function PlaceName({ x, y, z = 0, size = 9.5, children, }) {
    const point = (0, project_1.iso)(x, y, z);
    return ((0, jsx_runtime_1.jsx)("text", { x: point.x, y: point.y, textAnchor: "middle", fill: "#5C5048", stroke: "#F4EFE4", strokeWidth: 3, paintOrder: "stroke", fontFamily: "var(--font-display), ui-serif, Georgia, serif", fontSize: size, fontWeight: "500", letterSpacing: "0.03em", style: { pointerEvents: "none" }, children: children }));
}
function Court({ x, y, w, d }) {
    return ((0, jsx_runtime_1.jsxs)("g", { children: [(0, jsx_runtime_1.jsx)(primitives_1.IsoSlab, { x: x, y: y, w: w, d: d, h: 0.14, ...COURT }), (0, jsx_runtime_1.jsx)("polygon", { points: (0, project_1.isoPoints)([
                    [x + 0.12, y + 0.12, 0.16],
                    [x + w - 0.12, y + 0.12, 0.16],
                    [x + w - 0.12, y + d - 0.12, 0.16],
                    [x + 0.12, y + d - 0.12, 0.16],
                ]), fill: "none", stroke: "#F4F0E8", strokeWidth: "1.2" })] }));
}
function NamedLawn({ x, y, w, d, stripes, }) {
    return ((0, jsx_runtime_1.jsxs)("g", { children: [(0, jsx_runtime_1.jsx)(primitives_1.IsoSlab, { x: x, y: y, z: 0.02, w: w, d: d, h: 0.12, ...GRASS }), Array.from({ length: stripes }, (_, index) => {
                if (index % 2 !== 0)
                    return null;
                const u0 = x + (index / stripes) * w;
                const u1 = x + ((index + 1) / stripes) * w;
                return ((0, jsx_runtime_1.jsx)("polygon", { points: (0, project_1.isoPoints)([
                        [u0, y, 0.15],
                        [u1, y, 0.15],
                        [u1, y + d, 0.15],
                        [u0, y + d, 0.15],
                    ]), fill: GRASS_STRIPE, opacity: "0.5" }, index));
            })] }));
}
function grove(originX, originY, count, stepX, stepY, stagger) {
...
function Trees({ reduceMotion }) {
    ...
    return ((0, jsx_runtime_1.jsx)("g", { "data-layer": "trees", children: trees.map((tree, index) => ((0, jsx_runtime_1.jsx)(primitives_1.IsoTree, { x: tree.x, y: tree.y, canopy: tree.canopy, delay: `${(index % 6) * 0.16}s`, reduceMotion: reduceMotion }, `${tree.x}-${tree.y}-${index}`))) }));
}
function Life({ reduceMotion }) {
    return ((0, jsx_runtime_1.jsxs)("g", { "data-layer": "life", children: [(0, jsx_runtime_1.jsx)(primitives_1.IsoLamp, { x: SPINE_X + 0.35, y: 8.2 }), (0, jsx_runtime_1.jsx)(primitives_1.IsoLamp, { x: SPINE_X + SPINE_W - 0.55, y: 8.2 }), (0, jsx_runtime_1.jsx)(primitives_1.IsoLamp, { x: SPINE_X + 0.35, y: 4.2 }), (0, jsx_runtime_1.jsx)(primitives_1.IsoLamp, { x: SPINE_X + SPINE_W - 0.55, y: 4.2 }), (0, jsx_runtime_1.jsx)(primitives_1.IsoLamp, { x: SPINE_X + 0.2, y: 12.6 }), (0, jsx_runtime_1.jsx)(primitives_1.IsoLamp, { x: SPINE_X + SPINE_W + 0.15, y: 12.8 }), (0, jsx_runtime_1.jsx)(primitives_1.IsoLamp, { x: 27.4, y: -14.6 }), (0, jsx_runtime_1.jsx)(primitives_1.IsoLamp, { x: 35.2, y: -14.4 }), (0, jsx_runtime_1.jsx)(primitives_1.IsoPerson, { x: SPINE_MID - 0.8, y: 13.2, fill: "#5C5048", reduceMotion: reduceMotion, delay: "0s" }), (0, jsx_runtime_1.jsx)(primitives_1.IsoPerson, { x: SPINE_MID + 1.1, y: 14.0, fill: "#3F5C8A", reduceMotion: reduceMotion, delay: "0.4s" }), (0, jsx_runtime_1.jsx)(primitives_1.IsoPerson, { x: SPINE_MID + 0.2, y: 8.4, fill: "#C45C5C", reduceMotion: reduceMotion, delay: "0.9s" }), (0, jsx_runtime_1.jsx)(primitives_1.IsoPerson, { x: 29.6, y: -10.2, fill: "#6B5340", reduceMotion: reduceMotion, delay: "0.2s" }), (0, jsx_runtime_1.jsx)(primitives_1.IsoPerson, { x: 26.4, y: -8.8, fill: "#3F5C8A", reduceMotion: reduceMotion, delay: "1.1s" })] }));
}
function IsoDisc({ x, y, z, r, fill, }) {
    const center = (0, project_1.iso)(x, y, z);
    return ((0, jsx_runtime_1.jsx)("ellipse", { cx: center.x, cy: center.y, rx: r * project_1.TILE_W * Math.SQRT2, ry: r * project_1.TILE_H * Math.SQRT2, fill: fill }));
}
